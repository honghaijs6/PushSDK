...
module.exports = {
    before: {
      ...
      create: [
        ...
        defaultSchemaPost({Helper,schema:['cmd','sn']}), /* this guy return err: on missing Default field */
        buildJsonFieldPost({ Helper ,schema :['cmd','sn'] }), // This guy create json field stringify
        defaultKeyFieldPost(),
      ...
      update: [
        ...
        defaultSchemaPost({Helper,schema:['cmd']}),
        buildJsonFieldPost({ Helper ,schema :['cmd'] }), // This guy create json field stringify
        defaultKeyFieldPut(), // auto add updatedAt field

      ],
      patch: [

        defaultSchemaPost({Helper,schema:['cmd','sn']}),
        buildJsonFieldPost({ Helper ,schema :['cmd','sn'] }), // This guy create json field stringify
        defaultKeyFieldPut(), // auto add updatedAt field
